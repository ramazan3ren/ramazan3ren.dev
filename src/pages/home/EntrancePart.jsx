      ...
      <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-center bg-lightCardColor dark:bg-darkThemeColor py-28 px-4 lg:py-36 lg:mt-20 ">
        <div className="text-black dark:text-white w-80 lg:w-[400px] xl:mr-16 mr-0 mt-7 lg:mt-0 xl:[zoom:1.2]">
          ...
          <div className="flex flex-row justify-center lg:justify-start mt-6">
            <Link to="iletisim" className="bg-primaryColor hover:bg-secondaryColor px-6 py-2 mr-4 text-white rounded-full transition-all">
              İletişime Geç
            </Link>
            <Link to="portfolyo" className="px-6 py-2 rounded-full border border-primaryColor text-primaryColor hover:bg-primaryColor hover:text-white dark:border-secondaryColor dark:text-secondaryColor dark:hover:text-white transition-all">
              Portfolyo
            </Link>
          </div>
        </div>
